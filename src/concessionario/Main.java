...
public class Main {
	...
	public static void modificaPersonale() {
		...
		case 1:
			...
			Boolean b = false;
			if (grado.equals("amministratore") || grado.equals("Amministratore"))
				b = true;
			tableD.insert(new Dipendente(cid, nome, cognome, b));
			break;
		case 2:
			System.out.println("Inserisci il CID del dipendente che vuoi eliminare: ");
			cid = input.nextInt();
